...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      borderRadius: {
        xs: '4px', sm: '6px', md: '8px', lg: '10px', xl: '14px', '2xl': '20px', '3xl': '28px',
      },
      boxShadow: {
      ...
      transitionDuration: {
        ...
        '250': '250ms', '300': '300ms', '400': '400ms', '500': '500ms',
      },
      keyframes: {
        ...
        'progress': { '0%': { backgroundPosition: '0% 50%' }, '100%': { backgroundPosition: '200% 50%' } },
      },
      animation: {
